import API, { setWebsocketOnError, setApiEntryPoint, legado_http_entry_point, setWebsocketOnMessage, } from './api';
...
const LeagdoApiResponseKeys = Array.of('isSuccess', 'errorMsg');
const notification = ElMessage;
/** Axios.Interceptor: check if resp is LeagaoLeagdoApiResponse*/
const responseCheckInterceptor = (resp) => {
 ...
 */
export const parseLeagdoHttpUrlWithDefault = (http_url) => {
...
setApiEntryPoint(...parseLeagdoHttpUrlWithDefault(ajax.defaults.baseURL));
export default API;
export * from './api';
