  ...
  <div :class="{ 'index-wrapper': true, night: isNight, day: !isNight }">
    <div class="navigation-wrapper">
      ...
      <div class="bottom-wrapper">
        ...
        <!-- 阶段八补全：书架管理操作入口 -->
        <div class="setting-wrapper">
          <div class="setting-title">书架管理</div>
          <div class="setting-item">
            <el-button size="small" @click="groupManagerVisible = true" title="分组管理">
              分组管理
            </el-button>
            <el-upload
              ...
              class="import-upload"
            >
              <el-button size="small" title="导入本地书籍">导入书籍</el-button>
            </el-upload>
            <el-button size="small" @click="rssArticlesVisible = true" title="订阅文章">
              订阅文章
            </el-button>
            <el-button size="small" @click="$router.push('/bookSource')" title="书源管理">
              书源管理
            </el-button>
            <el-button size="small" @click="$router.push('/rssSource')" title="RSS源管理">
              RSS源管理
            </el-button>
          </div>
        </div>
      ...
      <div class="bottom-icons">
        ...
        <div class="bottom-icon" @click="$router.push('/settings')" title="应用设置">
    ...
    <!-- 阶段八补全：分组管理对话框 -->
    <book-group-manager v-model="groupManagerVisible" />

    <!-- 阶段八补全：RSS 订阅文章对话框 -->
    <rss-articles v-model="rssArticlesVisible" />
  </div>
</template>
