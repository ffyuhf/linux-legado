...
const isBookSource = (source) => 'bookSourceName' in source;
export const isInvaildSource = source => {
...
export const getSourceUniqueKey = (source) => isBookSource(source) ? source.bookSourceUrl : source.sourceUrl;
export const getSourceName = (source) => isBookSource(source) ? source.bookSourceName : source.sourceName;
export const isSourceMatches = (source, searchKey) => {
...
export const convertSourcesToMap = (sources) => {
    const map = new Map();
